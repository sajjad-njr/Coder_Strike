...
public class Main {
    ...
    public static void showBedProducts(){
    ...
    public static void showTableProducts(){
    ...
    public static  void showWardrobeProducts(){
    ...
    public static void showDresserProducts(){
    ...
    public static void showChairProducts(){
    ...
    public static void showCouchProducts(){
    ...
    public static void showCabinetryProducts(){
    ...
    public static void showOttomanProducts(){
    ...
    public static void showStoolProducts(){
    ...
    public static void showChaiseLongueProducts(){
